...
class Tag extends \App\Entity\Tag implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Tag' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Tag' . "\0" . 'tag'];
        }
     ...
     * {@inheritDoc}
     */
    public function addTag(\App\Entity\Category $tag): \App\Entity\Tag
    {
     ...
     * {@inheritDoc}
     */
    public function removeTag(\App\Entity\Category $tag): \App\Entity\Tag
    {
