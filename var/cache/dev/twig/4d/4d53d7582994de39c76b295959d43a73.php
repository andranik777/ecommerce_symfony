...
class __TwigTemplate_ad2db4d93826c94b4cb5eea75c53fb87 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        <div class=\"col-md-8\">";
        // line 13
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 13, $this->source); })()), 'form', ["attr" => ["id" => "contact"]]);
        echo "</div>
        <div class=\"col-md-4\">
...
";
    ...
    {
        return array (  109 => 13,  105 => 11,  96 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block content %}
    ...
    <div class=\"row\">
        ...
        <div class=\"col-md-8\">{{ form(form,{'attr': {'id': 'contact'}}) }}</div>
        <div class=\"col-md-4\">
            <strong>La Boutique Française</strong>
            <hr>
            06 20 30 40 50<br/>
